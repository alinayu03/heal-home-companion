    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <nav className="py-6 px-8 flex justify-between items-center">
        <div className="flex items-center space-x-2">
          ...
          <span className="font-medium text-xl">Relief</span>
        </div>
      ...
      <section className="py-24">
        <div className="max-w-4xl mx-auto px-8 text-center">
          <p className="text-2xl md:text-3xl font-light italic text-gray-600 mb-8">
            "Having Relief.AI in my home has brought a sense of calm and organization I didn't think was possible. It's like having a thoughtful friend who's always there when you need them."
          </p>
      ...
      <footer className="bg-gray-50 py-12">
        <div className="max-w-6xl mx-auto px-8 flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
          ...
          <p className="text-sm text-gray-500">© 2025 Relief AI Assistant</p>
        </div>
      </footer>
    </div>
  );
