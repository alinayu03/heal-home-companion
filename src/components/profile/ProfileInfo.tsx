...
import { User, FileImage, Heart, Plus, ChevronDown, Loader2 } from 'lucide-react';
...
const ProfileSummary: React.FC<ProfileSummaryProps> = ({ summaryText, patientName, patientType, labels, scores, result }) => {
  return (
    <Card className="shadow-lg border border-gray-200 bg-gradient-to-br from-white/90 to-white/70 backdrop-blur-md transition-all duration-300 hover:shadow-xl hover:scale-[1.01]">
      <CardHeader>
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center space-x-4">
            <div>
              <CardTitle className="text-lg font-semibold text-gray-900 text-blue-700">{patientName}</CardTitle>
              <CardDescription className="text-sm text-gray-600">{patientType}</CardDescription>
            </div>
          </div>
        </div>
      ...
      <CardContent className="">
        ...
        {labels && scores && (
          <div className="mb-4">
            <h4 className="text-sm font-medium text-gray-700 mb-2 text-indigo-600">Wellness Results:</h4>
                ...
                <div className="flex items-center justify-between bg-gray-50/50 p-2 rounded-md">
                  ...
                  <div className="flex-1 mx-2 h-4 bg-gray-200 rounded-full">
                    ...
                    {(() => {
                      ...
                      const barColor = score > 0.5 ? 'bg-red-500' : 'bg-green-500';
                      const displayScore = isNaN(score) ? 'N/A' : `${score.toFixed(2)}`;
                      const widthPercentage = isNaN(score) ? 0 : Math.min(score, 1) * 100; //convert to percentage
                      return (
                        <div
...
const ProfileInfo: React.FC = () => {
    ...
    return (
      <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-md relative" role="alert">
        ...
        <button
          ...
          aria-label="Retry"
        >
          <svg className="h-6 w-6 fill-current" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><title>Retry</title><path d="M8 5v2a4 4 0 0 0 4 4h5a2 2 0 0 1-2-2v-1c0-.55-.22-1.05-.59-1.41L10 2.59l-3.41 3A2 2 0 0 1 6 7V5a2 0 0 1 2-2zM6.59 15.59L10 17.41l3.41-3A2 2 0 0 1 14 13v2a2 0 0 1-2 2H7a4 4 0 0 0-4-4v-2c0-.55.22-1.05.59-1.41z" /></svg>
        </button>
      </div>
    );
  }
  ...
  const cardVariants = {
    ...
    hover: { scale: 1.01, boxShadow: "0px 6px 15px rgba(0, 0, 0, 0.1)", transition: { duration: 0.2 } }
  };
          ...
          <Card className="border-none bg-transparent">
            <CardHeader>
              <div className="flex items-center space-x-6">
                <Avatar className="h-16 w-16 border-4 border-health-primary shadow-lg">
                  ...
                  <AvatarImage src="https://source.unsplash.com/150x150/?peep" alt="Profile" />
                  <AvatarFallback className="bg-health-secondary text-health-primary text-2xl font-semibold">
                    JD
                  </AvatarFallback>
                </Avatar>
                <div>
                  <CardTitle className="text-3xl font-bold text-gray-900">John Doe</CardTitle>
            ...
            <CardContent className="space-y-8">
              <div>
                ...
                <div className="space-y-6">
                  <motion.div variants={medicalInfoVariants} initial="hidden" animate="visible" custom={0}>
                    <div className="bg-gray-50/50 p-4 rounded-lg border border-gray-100">
                      <h4 className="text-sm font-medium text-gray-700">Recent Procedures</h4>
                  ...
                  <motion.div variants={medicalInfoVariants} initial="hidden" animate="visible" custom={1}>
                    <div className="bg-gray-50/50 p-4 rounded-lg border border-gray-100">
                  ...
                  <motion.div variants={medicalInfoVariants} initial="hidden" animate="visible" custom={2}>
                    <div className="bg-gray-50/50 p-4 rounded-lg border border-gray-100">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <motion.div
                    ...
                    whileHover={{ scale: 1.03, boxShadow: "0px 5px 12px rgba(0, 0, 0, 0.1)" }}
                  >
                    <h4 className="font-medium text-gray-900">Dr. Sarah Johnson</h4>
                    <p className="text-sm text-gray-600">Primary Surgeon</p>
                    <p className="text-sm text-blue-600 mt-2 font-medium">Contact</p>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    whileHover={{ scale: 1.03, boxShadow: "0px 5px 12px rgba(0, 0, 0, 0.1)" }}
                  >
                    <h4 className="font-medium text-gray-900">Dr. Robert Chen</h4>
              ...
              <div>
                <h3 className="text-xl font-semibold mb-6 text-blue-700">Emergency Contacts</h3>
            ...
            <CardFooter>
              <Button
                ...
                whileHover={{ backgroundColor: '#f0f0f0', scale: 1.01, boxShadow: "0px 3px 7px rgba(0, 0, 0, 0.1)" }}
              >
